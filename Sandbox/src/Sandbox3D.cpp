...
void Sandbox3D::OnAttach()
{
	...
	//m_Model = Sisyphus::CreateRef<Sisyphus::Model>("assets/models/back_pack/backpack.obj");


	
	//auto loaded_mesh = m_Model->GetMeshes()[0];
	//loaded_mesh->PrintInfo();
	//loaded_mesh->SetMaterial(Sisyphus::CreateRef<Sisyphus::Material>());
